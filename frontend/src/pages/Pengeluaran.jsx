...
const Pengeluaran = () => {
  const { outboundLoads, suratJalan, settings, startOutboundLoad, completeOutboundLoad, createConsignmentReturn, settleOutboundDocument, cancelOutboundLoad } = useData();
