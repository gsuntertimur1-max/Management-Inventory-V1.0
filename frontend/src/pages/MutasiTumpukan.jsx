...
const MutasiTumpukan = () => {
  ...
  return <div className="space-y-6">
    ...
    <div className="card-surface p-5 md:p-6">
      <div className="flex items-center justify-between gap-3 mb-4"><div><h2 className="font-display text-xl font-bold">Riwayat Mutasi Terakhir</h2><p className="text-xs text-[#8b93a1] mt-1">Perpindahan lokasi fisik tanpa perubahan total stok.</p></div><button onClick={loadHistory} className="p-2 rounded-lg border border-[#242f3d] text-[#93c5fd]" title="Perbarui"><RefreshCcw size={16} /></button></div>
