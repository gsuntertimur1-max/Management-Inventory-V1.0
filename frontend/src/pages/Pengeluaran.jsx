...
const Pengeluaran = () => {
  const { user, outboundLoads, suratJalan, settings, startOutboundLoad, completeOutboundLoad, createConsignmentReturn, settleOutboundDocument, cancelOutboundLoad, editOutboundLoad } = useData();
