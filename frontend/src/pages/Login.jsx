...
const Login = () => {
  ...
  const submit = async (e) => {
    ...
    else toast.error(res.error || 'Nama pengguna atau kata sandi salah');
  };
  ...
  return (
    <div className="app-bg flex flex-col items-center justify-center min-h-screen px-4">
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          <div className="font-display font-bold text-2xl tracking-tight">PEPEG</div>
          <div className="text-xs text-[#aab4c4] leading-snug">Platform Elektronik Pengendalian dan Evaluasi Gudang</div>
      ...
      <div className="card-surface w-full max-w-md p-8 fade-up">
        ...
        <form onSubmit={submit} className="space-y-4">
          <div>
            <label className="text-sm font-medium mb-1.5 block">Nama Pengguna</label>
          ...
          <div>
            ...
            <p className="text-xs text-[#6b7688] mt-1.5">Kata sandi membedakan huruf besar dan kecil. Ketuk ikon mata untuk memeriksa ketikan Anda.</p>
          </div>
        ...
        <div className="mt-6 p-3 rounded-lg bg-[#0b0f17] border border-[#1a222e] text-xs text-[#8b93a1] leading-relaxed">
          Gunakan akun yang dibuat administrator. Kata sandi awal administrator ditentukan melalui konfigurasi server dan harus segera diganti setelah masuk pertama kali.
        </div>
      </div>
    </div>
  );
