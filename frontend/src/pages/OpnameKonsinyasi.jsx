...
const OpnameKonsinyasi = () => {
  const { consignmentStock, consignmentOpnames, addConsignmentOpname, user } = useData();
  ...
  useEffect(() => { if (scopedDestination) setDestination(scopedDestination); }, [scopedDestination]);
