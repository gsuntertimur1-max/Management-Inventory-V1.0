...
const Pengeluaran = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      {consignmentSummary.length > 0 && <details className="card-surface border border-[#1f3657] group">
        <summary className="cursor-pointer list-none p-4 sm:p-5 flex items-center justify-between gap-3 select-none">
          <div>
            <div className="label-mono text-[10px] text-[#93c5fd]">Persediaan di luar stok gudang utama</div>
            <div className="font-display text-base sm:text-lg font-bold mt-1">Stok Konsinyasi Unit 18</div>
          </div>
          <div className="flex items-center gap-2 text-xs text-[#93c5fd]">
            <span>{consignmentSummary.length} saldo</span>
            <span className="text-lg transition-transform group-open:rotate-180">⌄</span>
          </div>
        </summary>
        <div className="border-t border-[#1f3657] p-4 sm:p-5 pt-3">
