...
const blank = (stackCode) => ({ productId: '', stackCode, length: 1, width: 1, height: 1, arrangements: [{ hamparan: 1, kaki: 1, height: 1 }], extraSecondary: 0, note: '' });
...
const TumpukanStok = () => {
  ...
  const save = async () => {
    ...
    const payload = { ...modal.data, length: Number(first.hamparan), width: Number(first.kaki), height: Number(first.height), extraSecondary: Number(modal.data.extraSecondary || 0) };
